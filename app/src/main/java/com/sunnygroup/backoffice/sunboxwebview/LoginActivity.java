...
//    private UserLoginTask mAuthTask = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // If no saved username or password ask the user to login.
...
//        MyVolleyRequest volleyRequest = MyVolleyRequest.getInstance(mContext);
//
...
//
//                        showProgress(false);
//                        if (!response.contains(getString(R.string.login_err_code))) {
//                            storeCredentials(username, password); // login was successful so save the credentials
//                            Intent intent = new Intent(mContext, MainActivity.class);
//                            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                            startActivity(intent);
//                            finish();
//                        } else {
//                            mPasswordView.setError(getString(R.string.error_logging_in));
...
//        volleyRequest.addToRequestQueue(request);
        ...
        intent.putExtra("accountType", "licensee");
        intent.putExtra("id", "5a280c4360697e047689834a");
...
//
//            if (success) {
//                storeCredentials(mUsername, mPassword); // login was successful so save the credentials
//                Intent intent = new Intent(mContext, MainActivity.class);
//                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                startActivity(intent);
//                finish();
